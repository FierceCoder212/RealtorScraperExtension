...
setTimeout(() => {
  try {
    const listingContainer = document.querySelector("div[data-testid*=main-content] div[data-testid=hero-container]+div:has(div[data-testid*=status-indicator])").outerHTML;
